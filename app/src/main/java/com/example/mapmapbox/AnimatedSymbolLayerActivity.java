...
public class AnimatedSymbolLayerActivity extends AppCompatActivity {
    ...
    private void animateTaxi() {
        ValueAnimator valueAnimator = ValueAnimator.ofObject((TypeEvaluator) new LatLngEvaluator(), taxi.current, taxi.next);
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
    ...
    private void addRandomCars() {
        ...
        style.addImage(RANDOM_CAR_IMAGE_ID,
                ((BitmapDrawable) getResources().getDrawable(R.drawable.icon_m32)).getBitmap());
