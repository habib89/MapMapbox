                ...
                mapboxMap.setStyle(new Style.Builder().fromUrl("mapbox://styles/mapbox/cj8gg22et19ot2rnz65958fkn"),
                        new Style.OnStyleLoaded() {
                            ...
                            public void onStyleLoaded(@NonNull Style style) {
                                ...
                                Toast.makeText(MatrixApiActivity.this, "click_on_marker_instruction_toast",
...
//                        matrixApiLocationRecyclerViewAdapter.notifyDataSetChanged();
            ...
            public void onFailure(Call<MatrixResponse> call, Throwable throwable) {
                Toast.makeText(MatrixApiActivity.this, "call_error",
                        Toast.LENGTH_SHORT).show();
    ...
    private void addMarkers() {
        Icon lightningBoltIcon = IconFactory.getInstance(MatrixApiActivity.this)
                .fromResource(R.drawable.icon_m32);
