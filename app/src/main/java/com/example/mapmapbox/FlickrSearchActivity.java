...
// This contains the MapView in XML and needs to be called after the access token is configured.
                ...
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        style.addLayer(new LineLayer("linelayer", "line-source").withProperties(
                                ...
                                PropertyFactory.lineColor(Color.parseColor("#96281b"))
                        ));

                        Bitmap icon = BitmapFactory.decodeResource(getResources(), R.drawable.icon_m32);
                        mapboxMap.getStyle().addImage("my-marker-image", icon);

                        SymbolLayer symbolLayer = new SymbolLayer("layer-id", "line-source");
                        symbolLayer.setProperties(
                                PropertyFactory.iconImage("my-marker-image"),
                                PropertyFactory.textField("KM"),
    ...
    private void initData(FeatureCollection featureCollection) {
