...
import com.example.mapmapbox.model.GeoParseUtil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(map -> {
            ...
            final int[][] clusterLayers = new int[][]{
                    ...
                    new int[]{20, ResourcesCompat.getColor(getResources(), R.color.mapboxGreenDark, getTheme())},
                    new int[]{0, ResourcesCompat.getColor(getResources(), R.color.mapboxGreen, getTheme())}
            };
            ...
            try {
                mapboxMap.setStyle(new Style.Builder()
                        ...
                        .withImage("icon-id", Objects.requireNonNull(
                                BitmapUtils.getBitmapFromDrawable(getResources().getDrawable(R.drawable.icon_m32))), true
                        )
                );
