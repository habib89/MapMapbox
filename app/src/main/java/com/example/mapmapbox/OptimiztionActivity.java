...
public class OptimiztionActivity extends AppCompatActivity implements OnMapReadyCallback,
...
// Setup the MapView
    ...
    public boolean onMapClick(@NonNull LatLng point) {
        if (alreadyTwelveMarkersOnMap()) {
            Toast.makeText(OptimiztionActivity.this, "only_twelve_stops_allowed", Toast.LENGTH_LONG).show();
        } else {
...
//                Toast.makeText(OptimizationActivity.this, R.string.click_instructions, Toast.LENGTH_SHORT).show();
                mapboxMap.addOnMapClickListener(OptimiztionActivity.this);
                mapboxMap.addOnMapLongClickListener(OptimiztionActivity.this);
            }
        });
    }
        ...
        optimizedClient.enqueueCall(new Callback<OptimizationResponse>() {
            ...
            public void onResponse(Call<OptimizationResponse> call, Response<OptimizationResponse> response) {
                if (!response.isSuccessful()) {
                    ...
                    Toast.makeText(OptimiztionActivity.this, R.string.no_success, Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    if (response.body().trips().isEmpty()) {
                        Timber.d("%s size = %s", getString(R.string.successful_but_no_routes), response.body().trips().size());

                        Toast.makeText(OptimiztionActivity.this, "successful_but_no_routes",
