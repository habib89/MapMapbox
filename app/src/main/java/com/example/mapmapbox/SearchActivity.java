...
import com.example.mapmapbox.adapter.RecyclerAdapter;
...
//        toolbar.setNavigationIcon(R.drawable.icon_m32);
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.isEmpty()) adapter.notifyDataSetChanged();
                    ...
                    MapboxGeocoder client = new MapboxGeocoder.Builder()
                            .setAccessToken(getString(R.string.accses_tokon))
                            .setLocation(newText)
                            .build();
                    ...
                    client.enqueue(new Callback<GeocoderResponse>() {
                        ...
                        @Override
                        public void onResponse(Response<GeocoderResponse> response, retrofit.Retrofit retrofit) {
