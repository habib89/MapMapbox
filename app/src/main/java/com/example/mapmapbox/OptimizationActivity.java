...
// Add origin and destination to the mapboxMap
        ...
        Toast.makeText(OptimizationActivity.this, "click_instructions", Toast.LENGTH_SHORT).show();
...
// Optimization API is limited to 12 coordinate sets
        ...
        Toast.makeText(OptimizationActivity.this, "only_twelve_stops_allowed", Toast.LENGTH_LONG).show();
        } else {
