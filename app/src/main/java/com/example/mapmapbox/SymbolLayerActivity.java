...
// Add the LineLayer to the map. This layer will display the directions route.
        routeLayer.setProperties(
                ...
                lineWidth(5f),
                lineColor(Color.parseColor("#ba3b3f"))
        );
...
//
        client.enqueueCall(new Callback<DirectionsResponse>() {
            ...
            public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                ...
                Toast.makeText(SymbolLayerActivity.this, String.format(
                        getString(R.string.directions_activity_toast_message),currentRoute.distance()), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                ...
                Toast.makeText(SymbolLayerActivity.this, "Error: " + throwable.getMessage(),
